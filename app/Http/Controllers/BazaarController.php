...
class BazaarController extends Controller
{
    ...
    private function seedBazaars()
    {
        $data = [
            // CAIRO
            [
                'title' => 'خان الخليلي (Khan El Khalili)',
                'location' => 'القاهرة',
            ...
            [
                'title' => 'سوق الفسطاط (Souq El Fustat)',
                'location' => 'القاهرة',
            ...
            [
                'title' => 'وكالة البلح (Wekalet El Balah Market)',
                'location' => 'القاهرة',
            ...
            // GIZA
            [
                'title' => 'بازارات أهرامات الجيزة (Giza Pyramids Bazaar)',
                'location' => 'الجيزة',
            ...
            [
                'title' => 'معهد البردي (Papyrus Institute)',
                'location' => 'الجيزة',
            ...
            [
                'title' => 'النسر الذهبي للبردي (Golden Eagle Papyrus)',
                'location' => 'الجيزة',
            ...
            // ALEXANDRIA
            [
                'title' => 'سوق العطارين (Attarine Market)',
                'location' => 'الإسكندرية',
            ...
            [
                'title' => 'سوق الجمعة (Souq El Gomaa Alexandria)',
                'location' => 'الإسكندرية',
            ...
            [
                'title' => 'محلات تذكارات ستانلي (Stanley Souvenir Shops)',
                'location' => 'الإسكندرية',
            ...
            // LUXOR
            [
                'title' => 'سوق الأقصر السياحي (Luxor Souq)',
                'location' => 'الأقصر',
            ...
            [
                'title' => 'معرض حبيبة (Habiba Gallery)',
                'location' => 'الأقصر',
            ...
            [
                'title' => 'مصانع الألباستر (Alabaster Factory Luxor)',
                'location' => 'الأقصر',
            ...
            // ASWAN
            [
                'title' => 'سوق أسوان السياحي (Aswan Souq)',
                'location' => 'أسوان',
            ...
            [
                'title' => 'البازار النوبي (Nubian Bazaar)',
                'location' => 'أسوان',
            ...
            [
                'title' => 'سوق الشارع السياحي (Sharia Market Aswan)',
                'location' => 'أسوان',
            ...
            // SHARM EL SHEIKH
            [
                'title' => 'السوق القديم (Old Market Sharm)',
                'location' => 'شرم الشيخ',
            ...
            [
                'title' => 'محلات ميدان سوهو (SOHO Square Shops)',
                'location' => 'شرم الشيخ',
            ...
            [
                'title' => 'بازارات خليج نعمة (Naama Bay Market)',
                'location' => 'شرم الشيخ',
            ...
            // HURGHADA
            [
                'title' => 'سوق الدهار (El Dahar Bazaar)',
                'location' => 'الغردقة',
            ...
            [
                'title' => 'محلات شارع شيراتون (Sheraton Street Shops)',
                'location' => 'الغردقة',
            ...
            [
                'title' => 'بازارات سينزو مول (Senzo Mall Souvenirs)',
                'location' => 'الغردقة',
            ...
            // MARSA ALAM
            [
                'title' => 'محلات هدايا مرسى علم (Marsa Alam Souvenir Shops)',
                'location' => 'مرسى علم',
            ...
            [
                'title' => 'بازار بورت غالب (Port Ghalib Bazaar)',
                'location' => 'مرسى علم',
            ...
            [
                'title' => 'السوق البدوي (Bedouin Market Marsa Alam)',
                'location' => 'مرسى علم',
            ...
            // MARSA MATROUH
            [
                'title' => 'السوق المحلي (Matrouh Local Market)',
                'location' => 'مرسى مطروح',
            ...
            [
                'title' => 'السوق الليبي (Libyan Market Matrouh)',
                'location' => 'مرسى مطروح',
            ...
            // PORT SAID
            [
                'title' => 'بازار بورسعيد (Port Said Bazaar)',
                'location' => 'بورسعيد',
            ...
            [
                'title' => 'سوق المنطقة الحرة (Free Zone Market Port Said)',
                'location' => 'بورسعيد',
            ...
            [
                'title' => 'محلات حي العرب (Al Arab District Shops)',
                'location' => 'بورسعيد',
            ...
            [
                'title' => 'محلات قرية تونس (Tunis Village Shops)',
                'location' => 'الفيوم',
            ...
            [
                'title' => 'بازار بحيرة قارون (Qarun Lake Bazaar)',
                'location' => 'الفيوم',

...
class ChatbotController extends Controller
{
    ...
    public function ask(Request $request)
    {
        ...
        $fastResponses = [
            ...
            'الدفع ازاي' => 'بنوفرلك طرق دفع كتير وآمنة جداً: بطاقات الائتمان (فيزا/ماستركارد)، المحافظ الإلكترونية، وأحياناً الدفع عند الوصول لبعض الخدمات.',
            'الاسعار كام' => 'الأسعار بتختلف حسب المكان ومستوى الخدمة ووقت الرحلة. تقدر تتصفح أقسام الموقع عشان تشوف الأسعار المحدثة، أو تحددلي ميزانيتك وأنا أرشحلك الأنسب!',
            'تغيير الميعاد' => 'ولا يهمك! تقدر تعدل ميعاد حجزك أو تلغيه بكل سهولة من خلال الدخول على صفحة [حجوزاتي](/bookings) الخاصة بيك.',
            'عايز الغي' => 'تقدر تلغي الحجز بتاعك من خلال صفحة [حجوزاتي](/bookings). يرجى مراجعة سياسة الإلغاء الخاصة بالخدمة اللي حجزتها.',
            'سلام عليكم' => 'وعليكم السلام ورحمة الله وبركاته! أهلاً بيك في كيميت، أقدر أساعدك إزاي النهارده؟',
            'بقولك' => 'أؤمرني يا فندم! أقدر أساعدك إزاي؟',
            'اهلا' => 'أهلاً بك في كيميت! تحب أرشحلك أفضل الأماكن لرحلتك الجاية؟',
            'مين المندوب' => 'بيتم إرسال كل تفاصيل المندوب ورقم تليفونه على إيميلك بعد تأكيد الحجز مباشرة، وهيتواصل معاك قبل الرحلة بـ 24 ساعة.',
        ];

...
class ChatbotController extends Controller
{
    ...
    public function ask(Request $request)
    {
        ...
        // --- نظام التوفير الذكي (Hybrid AI: 70% Rules / 30% LLM) ---
        // تقليل تكلفة الـ API عن طريق الرد على الأسئلة المتكررة محلياً
        $cleanMessage = mb_strtolower(trim($userMessage));
        
        $fastResponses = [
            'ازاي احجز' => 'ببساطة! تقدر تختار الخدمة اللي تعجبك (فندق، رحلة، سفاري) وتضغط عليها، وبعدين تختار التاريخ وتضغط على [حجز الآن].',
            'الدفع' => 'بنوفرلك طرق دفع كتير وآمنة جداً: بطاقات الائتمان (فيزا/ماستركارد)، المحافظ الإلكترونية، وأحياناً الدفع عند الوصول لبعض الخدمات.',
            'اسعار' => 'الأسعار بتختلف حسب المكان ومستوى الخدمة ووقت الرحلة. تقدر تتصفح أقسام الموقع عشان تشوف الأسعار المحدثة، أو تحددلي ميزانيتك وأنا أرشحلك الأنسب!',
            'بكام' => 'الأسعار بتختلف حسب المكان ومستوى الخدمة ووقت الرحلة. تقدر تتصفح أقسام الموقع عشان تشوف الأسعار المحدثة، أو تحددلي ميزانيتك وأنا أرشحلك الأنسب!',
            'تغيير' => 'ولا يهمك! تقدر تعدل ميعاد حجزك أو تلغيه بكل سهولة من خلال الدخول على صفحة [حجوزاتي](/bookings) الخاصة بيك.',
            'الغي' => 'تقدر تلغي الحجز بتاعك من خلال صفحة [حجوزاتي](/bookings). يرجى مراجعة سياسة الإلغاء الخاصة بالخدمة اللي حجزتها.',
            'سلام' => 'وعليكم السلام ورحمة الله وبركاته! أهلاً بيك في كيميت، أقدر أساعدك إزاي النهارده؟',
            'بقولك' => 'أؤمرني يا فندم! أقدر أساعدك إزاي؟',
            'اهلا' => 'أهلاً بك في كيميت! تحب أرشحلك أفضل الأماكن لرحلتك الجاية؟',
            'أهلا' => 'أهلاً بك في كيميت! تحب أرشحلك أفضل الأماكن لرحلتك الجاية؟',
            'هاي' => 'أهلاً بك في كيميت! تحب أرشحلك أفضل الأماكن لرحلتك الجاية؟',
            'الو' => 'أهلاً بك يا فندم! أقدر أساعدك إزاي النهارده؟',
            'ألو' => 'أهلاً بك يا فندم! أقدر أساعدك إزاي النهارده؟',
            'المندوب' => 'بيتم إرسال كل تفاصيل المندوب ورقم تليفونه على إيميلك بعد تأكيد الحجز مباشرة، وهيتواصل معاك قبل الرحلة بـ 24 ساعة.',
        ];

...
class EventSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $events = [
            ...
            ['title'=>'حفلات دار الأوبرا المصرية الكبرى','location'=>'Cairo','category'=>'Art','image'=>'/events/real_cairo_film_fest.jpg','date'=>'2025-11-13','price'=>'150.00','description'=>'حفلات موسيقية كلاسيكية راقية في دار الأوبرا، تجربة ثقافية فخمة متاحة لجميع السياح والمصريين.'],
            ...
            // ── Alexandria (6 events) ────────────────────────────────────────
            ['title'=>'حفلات الكورنيش الصيفية المفتوحة','location'=>'Alexandria','category'=>'Music','image'=>'/events/real_alex_film_fest.jpg','date'=>'2025-09-20','price'=>'100.00','description'=>'سهرات صيفية رائعة على شاطئ البحر المتوسط تشمل عشاء فاخر وموسيقى حية مفتوحة لجميع الزوار.'],
            ...
            ['title'=>'رحلة دهبية فاخرة في النيل وقت الغروب','location'=>'Luxor','category'=>'Cultural','image'=>'/events/event_cairo_jazz.png','date'=>'2025-03-06','price'=>'120.00','description'=>'تجربة إبحار هادئة ومميزة على مركب الدهبية الفاخر مع عشاء بوفيه مفتوح وموسيقى حية وسط سحر النيل.'],
            ...
            ['title'=>'ليالي الفلكلور الفرعوني بالفنادق الكبرى','location'=>'Luxor','category'=>'Art','image'=>'/events/real_luxor_awards.jpg','date'=>'2025-03-10','price'=>'180.00','description'=>'سهرات ممتعة داخل قاعات الفنادق الفاخرة تقدم عروضاً فلكلورية وعشاء بوفيه مفتوح للجميع.'],
            ...
            ['title'=>'رحلة يخت VIP لجزيرة الجفتون','location'=>'Hurghada','category'=>'Sport','image'=>'/events/ev_hurghada_dolphins.jpg','date'=>'2025-10-10','price'=>'150.00','description'=>'رحلة بحرية فاخرة ليوم كامل على متن يخت يشمل الغطس، السباحة، وشواء المأكولات البحرية الطازجة على الشاطئ.'],

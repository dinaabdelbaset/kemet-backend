...
class EventSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $events = [
            ...
            ['title'=>'مؤتمر شرم الشيخ للسياحة المستدامة','location'=>'Sharm El-Sheikh','category'=>'Cultural','image'=>'/events/real_sharm_eco_conf.jpg','date'=>'2025-09-01','price'=>'350.00','description'=>'مؤتمر دولي يجمع خبراء البيئة والسياحة لمناقشة حماية الشعاب المرجانية ومستقبل السياحة البيئية.'],
            ...
            ['title'=>'مهرجان الجونة السينمائي الدولي (GFF)','location'=>'Hurghada','category'=>'Art','image'=>'/events/real_gouna_film_fest.jpg','date'=>'2025-10-10','price'=>'200.00','description'=>'مهرجان سينمائي دولي راقٍ بالجونة، يستضيف نجوم السينما العالمية بجانب قنوات المياه وأضواء النيل الوهاجة.'],
            ...
            ['title'=>'ماراثون الصحراء الفيومية','location'=>'Fayoum','category'=>'Sport','image'=>'/events/ev_fayoum_marathon.jpg','date'=>'2025-12-15','price'=>'150.00','description'=>'ماراثون عبر تضاريس الفيوم المتنوعة — صحراء وأودية وبحيرات — تجربة فريدة لعشاق الرياضة في الطبيعة.'],
        ];

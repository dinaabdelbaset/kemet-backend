...
class EventSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $events = [
            ...
            ['title'=>'عشاء أسطوري بساحة معبد الأقصر','location'=>'Luxor','category'=>'Cultural','image'=>'/events/real_luxor_film_fest.jpg','date'=>'2025-03-06','price'=>'120.00','description'=>'تجربة عشاء ملكي في الساحة المفتوحة قرب معبد الأقصر مع عروض ترفيهية حية مفتوحة للسياح والزوار.'],
            ...
            ['title'=>'حفلات مارينا الجونة الصيفية','location'=>'Hurghada','category'=>'Music','image'=>'/events/real_gouna_film_fest.jpg','date'=>'2025-10-10','price'=>'150.00','description'=>'حفلات ليلية نابضة بالحياة في مارينا الجونة تجمع السياح والمصريين للاستمتاع بالموسيقى وسط اليخوت المضيئة.'],
